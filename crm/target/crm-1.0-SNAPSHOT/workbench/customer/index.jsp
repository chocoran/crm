    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#selectCustomer").click(function () {
                ...
                $("#old-phone").val($.trim($("#phone").val()));
                $("#old-website").val($.trim($("#website").val()));
                pageList(1, 5);
            })
            ...
            $("#showBody").on("click", $("input[name=id]"), function () {
                $("#selectAll").prop("checked", $("input[name=id]:checked").length == $("input[name=id]").length)
            })
        ...
        function pageList(pageCount, pageSize) {
            ...
            $("#phone").val($.trim($("#old-phone").val()));
            $("#website").val($.trim($("#old-website").val()));
            $("#selectAll").val("");
            $.ajax({
                url: "workbench/customer/showCustomer.do",
                ...
                success: function (data) {
                    ...
                    $.each(data.pageList, function (k, v) {
                        ...
                        html += 'onclick="window.location.href=\'workbench/customer/detail.jsp\';">' + v.name + '</a></td>'
                        html += '<td>' + v.owner + '</td>'
                        html += '<td>' + v.phone + '</td>'
                        html += '<td>' + v.website + '</td>'
                        html += '</tr>'
                    })
                    $("#showBody").html(html);
...
<input type="hidden" id="old-website">
<input type="hidden" id="old-phone">
    ...
    <div style="width: 100%; position: absolute;top: 5px; left: 10px;">
        ...
        <div class="btn-toolbar" role="toolbar" style="height: 80px;">
            <form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
                ...
                <button type="submit" class="btn btn-default" id="selectCustomer">查询</button>
